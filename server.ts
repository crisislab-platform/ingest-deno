...
async function reqHandler(request: Request) {
  ...
  if (pathname.startsWith("/consume/")) {
    ...
    if (request.headers.get("Upgrade") != "websocket") {
      ...
      return await serveFile(request, "/home/b/bhong/ingest-deno2/live-data-graphs/dist/index.html");
    }

    return clientHandler(request);
  } 
  
  if (pathname === "/") return await serveFile(request, "/home/b/bhong/ingest-deno2/live-data-graphs/dist/index.html");

  return await serveFile(request, "/home/b/bhong/ingest-deno2/live-data-graphs/dist" + pathname);
}
