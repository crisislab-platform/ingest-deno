...
with open("rs4d-sensor-ips.csv") as f:
    ...
    for row in data:
        ...
        try:
            ...
            ssh.connect(ip, username="myshake", password="shakeme", timeout=30, disabled_algorithms={'keys': ['rsa-sha2-256', 'rsa-sha2-512']})
...
""")
            ...
            if len(errors) == 0:
                ...
                failed_list.append([id, ip, errors])


        except Exception as err:
            print(f"Error uploading sensor #{id}")
            print(err)
